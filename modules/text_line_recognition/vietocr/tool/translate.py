...
def translate(img, model, max_seq_length=128, sos_token=1, eos_token=2):
    ...
    with torch.no_grad():
        ...
        # print('time encoder: ', time.time() - st)
...
#            output = model.transformer(src, tgt_inp, tgt_key_padding_mask=None)
        ...
        # print('time decoder: ', time.time() - st)
    ...
    return translated_sentence, char_probs, (cnn_time, encoder_time, decoder_time)
